...
3. **Validate** your work using task-provided commands (build/test/lint as specified)
...
5. **Validate.** Tier 2: build-validator. Tier 3: build-validator + verify-app. Use task-provided validation commands only; tier shorthand is metadata, not a shell command.
