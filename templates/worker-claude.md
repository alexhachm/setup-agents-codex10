...
5. **Validate.** Tier 2: build-validator. Tier 3: build-validator + verify-app. Validation shorthand (`tier2`/`tier3`) is metadata; run only explicit task commands and never infer `npm run build`.
