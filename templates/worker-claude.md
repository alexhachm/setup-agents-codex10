...
3. **Validate** using task-provided commands and validator flow (no implicit `npm run build`)
...
5. **Validate.** Tier 2: build-validator. Tier 3: build-validator + verify-app. Follow task-provided commands and do not assume `npm run build`.
