...
5. **Validate.** Tier 2: build-validator. Tier 3: build-validator + verify-app. Run only explicit task-provided validation commands; `tier2`/`tier3` are metadata and do not imply `npm run build`.
