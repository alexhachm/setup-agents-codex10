...
1. Check current system state:
   ```bash
   ./.codex/scripts/codex10 status && ./.codex/scripts/codex10 worker-status
   ```

2. Read knowledge files:
   - `.codex/knowledge/codebase-insights.md`
   - `.codex/knowledge/patterns.md`
   - `.codex/knowledge/allocation-learnings.md`
   - `.codex/knowledge/domain/` (all files)

3. Check for Master-2's codebase map:
   - Read `.codex/state/codebase-map.json` if it exists
