...
- **Autosave rebase commits:** Skipping conflicted `[auto-save] preserve working changes before rebase` commits can leave partial `.codex` trees in worktrees; re-validate `.codex/knowledge` + `.codex/scripts/codex10` immediately after rebase.
